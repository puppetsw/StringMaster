...
public class StringCogoPointsViewModel : ObservableObject
{
	...
	private readonly ICivilPointGroupService _civilPointGroupService;
	...
	private ObservableCollection<string> _pointGroups;
	private string _selectedPointGroup;
	...
	public ObservableCollection<string> PointGroups
	{
		get => _pointGroups;
		set => SetProperty(ref _pointGroups, value);
	}

	public string SelectedPointGroup
	{
	...
	public StringCogoPointsViewModel(IOpenDialogService openDialogService,
									 ...
									 ICivilPointGroupService civilPointGroupService)
	{
		...
		_civilPointGroupService = civilPointGroupService;
